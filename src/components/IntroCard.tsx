...
const IntroCard = () => {
  return (
    <div>
      <div className="rounded-lg w-fit z-20 relative bg-gradient-to-br from-neutral-900 to-neutral-700 border-slate-300 border ring-4 ring-stone-900  overflow-hidden ">
